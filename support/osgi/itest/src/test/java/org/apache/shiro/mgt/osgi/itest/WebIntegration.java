...
public Option[] config() throws URISyntaxException {
    ...
    return new Option[] {
        ...
        keepRuntimeFolder(),
	features(karafStandardRepo, "webconsole", "war"),
	features(shiroRepo, "Preset_Web", "WebSample"),
	mavenBundle().groupId("org.apache.servicemix.bundles").artifactId("org.apache.servicemix.bundles.jstl").versionAsInProject(),
